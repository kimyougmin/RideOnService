    ...
    <div>
      <article className="flex flex-col lg:gap-12 gap-4">
        <div className="flex flex-col lg:gap-12 gap-4">
          ...
          <p className="text-md lg:text-20 text-bold m-0 dark:text-black1 sm:inline hidden">
        ...
        <div className="grid grid-cols-12 gap-8">
          <Link href="bicycleSearch/1" className="col-span-6">
            <Image src="/main/main_bike_brand.png" alt="bike facility" className="mb-4" width={800} height={500}/>
          </Link>
          <Link href="bicycleSearch/2" className="col-span-6">
            <Image src="/main/main_bike_category.png" alt="bike facility" className="mb-4"  width={800} height={500}/>
          </Link>
        </div>
      </article>
    </div>
